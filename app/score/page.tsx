...
export default function Page() {
  ...
  const mitigationMap = new Map(allMitigations.map(mitigation => [mitigation.mitigationNumber, mitigation]));
  ...
  const scored = allScores.map((score) => {
    ...
    const totalRiskMitigated = totalIntelligibilityRiskMitigated + totalLongevityRiskMitigated + totalConsistencyRiskMitigated + totalCorrectnessRiskMitigated;
