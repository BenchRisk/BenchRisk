...
-- Kevin Roose, [reporting for the New York Times](https://www.nytimes.com/2024/04/15/technology/ai-models-measurement.html)
...
The research paper associated with BenchRisk was recently accepted into the [The Thirty-Ninth Annual Conference on Neural Information Processing Systems](https://neurips.cc/). Our preferred citation is the [arXiv version](https://arxiv.org/abs/2510.21460).
...
[Download the paper](https://arxiv.org/abs/2510.21460)

## The Organization

BenchRisk is operated by the [AI Verification and Evaluation Research Institute (AVERI)](https://averi.org/). For all correspondances, please contact code@averi.org.
